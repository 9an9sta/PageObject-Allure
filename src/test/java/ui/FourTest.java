...
public class FourTest extends BaseTest {
    ...
    public void checkThatPriceCorrectly(){
        ...
        softly.assertThat(expectedDollarPrice).as("Dollar price are different").isEqualTo(actualDollarPrice);
        ...
        softly.assertThat(actualPoundSterlingPrice).as("Pound Sterling are different").isEqualTo("95.32");
        softly.assertAll();
    }
