...
public class DesktopComponents {
  ...
  public DesktopComponents(WebElement container) {
    ...
    this.exTax = container.findElement(By.xpath(".//div[@class='price']//span[@class='price-tax']"))
        .getText().substring(8);
    this.addToCard = container.findElement(
        By.xpath(".//div[@class='button-group']/button[@aria-label='Add to Cart']"));
    this.addToWishList = container.findElement(
        By.xpath(".//div[@class='button-group']/button[@aria-label='Add to Wish List']"));
    this.compareThisProduct = container.findElement(
        By.xpath(".//div[@class='button-group']/button[@aria-label='Compare this Product']"));
